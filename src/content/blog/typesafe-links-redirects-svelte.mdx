...
pubDate: "2025-05-13"
heroImage: "/hero-images/typesafe-links-redirects-svelte.jpg"
---

One of the great features of SvelteKit is its phenomenal built-in routing and data loading capabilities. But as the number of pages and forms grows in your app, making refactors or changes to a page or even a layout might introduce some runtime bugs. That is because SvelteKit doesn't provide any way to check if an `href` in an anchor tag or a url value in a `redirect` is valid. We need a way to gurantee that all our links, redirects, and even form actions are valid at compile time.
